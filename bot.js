...
const kanal = member.guild.channels.find("name", "giris-cikis")
...
client.on('guildCreate', guild => {
  ...
  .addField('**Türkiye`m sunucunuza eklendi!**', `${owner}`)
  .addField('**Türkiye`m** sunucunuzdaki insanlara kolaylıklar sağlar.', `**${prefix}bilgi** yazmanız yeterlidir!`)
...
client.on('guildCreate', guild => {
  ...
  .setFooter('Türkiye`m', client.user.avatarURL)
  .setTimestamp()
